...
import type { DemoRequest as _DemoRequest } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMyDemoRequest(): Promise<DemoRequest | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyDemoRequest();
    ...
    async hasDemoRequest(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasDemoRequest();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeMyDemoRequest(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeMyDemoRequest();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeSelfAsAdmin(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeSelfAsAdmin();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDemoRequest(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDemoRequest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DemoRequest]): DemoRequest | null {
